...
// 카테고리에 다이어리 추가
router.put('/:category_id/diaries/:diary_id', isAuth, categoryController.addDiaryToCategory)

// 카테고리에서 다이어리 제거
router.delete('/diaries/:diary_id', isAuth, categoryController.deleteDiaryFromCategory)
